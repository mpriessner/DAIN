...
def create_folder_T(root, folder_name, ticker_2):
  os.chdir(root)
...
# destination, sequence_path = create_folder_T(root, folder_name)

def run_create_training_T(filepath, destination, k, sequence_path, split_training_test):
  # get file-path-list
  filepath_list = get_file_list_T(filepath)
...
# run_create_training_T(filepath, destination)
