...
def load_img_Z(img_path, channel, t):
...
def create_foldersystem_Z(root,img_path_list):
  ...
  img_path_list = []
  img_path_list = get_img_path_list_Z(img_path_list, filepath)
...
def run_code_Z(destination, img_path_list, nr_channels, nr_timepoints, nr_z_slices, multiplyer, channel_dict):
  ...
  for img_path in tqdm(img_path_list):
      for channel in range(nr_channels):
        for t in range(nr_timepoints):
          img, x_div, y_div = load_img_Z(img_path, channel, t)
